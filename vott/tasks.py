...
class StorageQueueTaskSource(TaskSource):
    ...
    @classmethod
    def is_supported(cls):
        return cls.storage_account_name() and cls.storage_key()
...
class ServiceBusTaskSource(TaskSource):
    ...
    def __init__(self):
        self.service_bus = ServiceBusService(
            service_namespace=ServiceBusTaskSource.service_bus_namespace(),
    ...
    @classmethod
    def service_bus_namespace(cls):
        return os.environ.get('AZURE_SERVICE_BUS_NAMESPACE')

    @classmethod
    def is_supported(cls):
        return cls.service_bus_namespace()
